-- Security hardening: RLS policies, grants, indexes, trigger guard
-- (Use 20250614000007 for idempotent re-runs on partially applied databases)
...
-- ---------------------------------------------------------------------------
-- admin_emails: no frontend access (service_role / triggers only)
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- profiles: no self-service updates; admins only; no direct inserts
-- ---------------------------------------------------------------------------
...
-- spin_logs: ensure only SELECT + INSERT (immutable audit trail)
