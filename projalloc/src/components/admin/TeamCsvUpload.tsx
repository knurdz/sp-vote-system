    ...
    <section className="panel mb-8 p-6 sm:p-8">
      ...
      <div className="rounded-2xl border border-dashed border-border bg-bg-base/40 p-5">
        <input
          ...
          className="block w-full text-sm text-text-secondary file:mr-4 file:rounded-xl file:border-0 file:bg-accent file:px-4 file:py-2 file:text-xs file:font-display file:font-bold file:uppercase file:tracking-wide file:text-[var(--accent-text)] hover:file:bg-accent-hover cursor-pointer"
        />
