...
const colors: Record<string, string> = {
  voting: 'bg-accent/8 backdrop-blur-[2px] text-green border border-accent/20 shadow-[0_2px_8px_rgba(0,201,120,0.06)]',
  ...
  admin: 'bg-accent/8 backdrop-blur-[2px] text-accent border border-accent/20 shadow-[0_2px_8px_rgba(0,201,120,0.06)]',
  leader: 'bg-accent/8 backdrop-blur-[2px] text-green border border-accent/20 shadow-[0_2px_8px_rgba(0,201,120,0.06)]',
